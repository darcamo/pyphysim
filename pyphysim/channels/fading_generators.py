...
# TODO: Remove this class after it is not required anymore (replaced with
# JakesSampleGenerator)
# noinspection PyPep8
class JakesSampleGeneratorOLD(object):
    """
    The purpose of this class is to generate samples according to
    the Jakes model given by
