...
# xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
class ClosedFormSimulationRunner(SimulationRunner):
    """
...
# Run the ClosedFormSimulationRunner and plot the results
if __name__ == '__main__':
    ...
    results_filename = 'ia_closed_form_results_{0}_{1}x{2}({3})'.format(
        modulator_name,
        Nr,
        Nt,
        Ns)
